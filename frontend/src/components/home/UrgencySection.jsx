...
export default function UrgencySection() {
  const featuredProduct = PRODUCTS[0]; // Golden Abundance
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-8 p-8 md:p-12 items-center">
            ...
            <div>
              ...
              <p className="text-white/60 mb-6 leading-relaxed">
                The <strong className="text-white">Money bracelet</strong> is flying off the shelves.
                Lock in this price before it's gone.
              </p>

              <div className="flex items-center gap-4 mb-6">
                <div>
                  <span className="font-bold text-3xl text-white">₹850</span>
                  <span className="text-white/40 line-through text-lg ml-2">₹1,999</span>
                </div>
                <span className="badge bg-red-500 text-white font-bold">SAVE ₹1,150</span>
              </div>
              ...
              >
                ...
                <div className="absolute -bottom-4 left-0 right-0 mx-4 glass rounded-xl p-3">
                  <div className="flex justify-between text-xs mb-1.5">
                    ...
                    <span className="text-white/50">47 of 200 left</span>
                  </div>
